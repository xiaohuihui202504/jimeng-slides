          ...
          <div className="flex items-center gap-3 mb-2">
            {isEditing ? (
              <input
                ...
                autoFocus
                className="text-lg font-semibold text-gray-900 px-2 py-1 border border-banana-500 rounded focus:outline-none focus:ring-2 focus:ring-banana-500 flex-1 min-w-0"
