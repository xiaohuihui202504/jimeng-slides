...
class FileParserService:
    ...
    def __init__(self, mineru_token: str, mineru_api_base: str = "https://mineru.net",
                 deepseek_api_key: str = "", deepseek_api_base: str = "",
                 image_caption_model: str = "deepseek-ai/DeepSeek-V3.2"):
        """
        ...
        Args:
            ...
            deepseek_api_key: DeepSeek API key for image captioning
        ...
        # Initialize DeepSeek client for image captioning
    ...
    def parse_file(self, file_path: str, filename: str) -> tuple[Optional[str], Optional[str], Optional[str], int]:
        ...
        try:
            ...
            if markdown_content and self.deepseek_client:
    ...
    def _parse_text_file(self, file_path: str, filename: str) -> tuple[Optional[str], Optional[str], Optional[str], int]:
        ...
        try:
            ...
            if content and self.deepseek_client:
            ...
            try:
                ...
                if content and self.deepseek_client and '![' in content and '](' in content:
                    logger.info("Text file contains images, enhancing with captions...")
                    enhanced_content, failed_count = self._enhance_markdown_with_captions(content)
                    if failed_count > 0:
                        logger.warning(f"Text file enhanced with image captions, but {failed_count} images failed to generate captions.")
    ...
    def _generate_single_caption(self, image_url: str) -> str:
        ...
        try:
            ...
            result = self.deepseek_client.chat.completions.create(
